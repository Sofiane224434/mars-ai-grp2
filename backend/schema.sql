...
-- -----------------------------------------------------
-- Data for table `marsai`.`status`
-- -----------------------------------------------------
START TRANSACTION;
USE `marsai`;
INSERT INTO `marsai`.`status` (`id`, `status`) VALUES (1, 'pending');
INSERT INTO `marsai`.`status` (`id`, `status`) VALUES (2, 'rejected');
INSERT INTO `marsai`.`status` (`id`, `status`) VALUES (3, 'review');
INSERT INTO `marsai`.`status` (`id`, `status`) VALUES (4, 'approved');
INSERT INTO `marsai`.`status` (`id`, `status`) VALUES (5, 'top50');
INSERT INTO `marsai`.`status` (`id`, `status`) VALUES (6, 'top5');
